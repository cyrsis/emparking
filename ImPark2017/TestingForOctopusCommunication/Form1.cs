...
//                var timeParts = DailyTime.Split(new char[1] { ':' });
        ...
        public static String CallGetSysInfo()
        {
            ...
            log.Info(" Info Data --"+ getSysInfoData);
...
(Convert.ToDecimal(balance) / 10).ToString("#,##.0")));
        ...
        private string BuildLastAddMessage(string lastAdd)
        {
            ...
            if (message[1].ToInt32() == 1 || message[1].ToInt32() == 4 || message[1].ToInt32() == 5)
            {
        ...
        CardEnquiry:
            ...
            //Data Samples:
            //Format : <Old  Card  ID>,<Old  Card  IDm>,<New  Card  ID>,<Customer  Info>,<New  IDm>  [Card  Log 
            //1],[Card Log 2],....,[Card Log 10] 
            //80012345,1234567890ABCDEF,90012345,1234-8765432-1-1-5,9234567890ABCDE
            //F,131,22,2272264,13398,A1A2A3A4A5,131,22,2272251,13398,A1A2A3A4A5,131
            //,22,2185478,13398,A1A2A3A4A5,131,22,2185028,13398,A1A2A3A4A5,131,22,2                      
            //184982,13398,A1A2A3A4A5,131,22,2184864,13398,A1A2A3A4A5,133,170,21004
            //60,34817,322B202000,133,170,2100449,34817,322B202000,133,170,2100261,       
            //34817,322B202000,133,63,2099997,34817,3231202000 
            if (PollStatus4 < 100000)
            {
                 
                //Transaction amount  Remarks  Example 
                //> 0  “+” (+ve)  +$100.0 
                //< 0  “-“ (-ve)  -$10.0 
                //0  No “+” or “-“ sign  $0.0 
                string FormatString = "+$###0.0;-$###0.0;$0.0";
                ...
                string[] temp3 = PollData.ToString().Split(",");
                string cardId = temp3[0];
                ...
                sqlResultTextBox.Text += @"Octopus card Remaining Value: " +
                                         (Convert.ToDecimal(PollStatus4) / 10).ToString(FormatString) + Environment.NewLine;
                ...
                sqlResultTextBox.Text += "     " + ((dateStrings[4].ToDecimal()) / 10).ToString(FormatString) + "       ";
                ...
                sqlResultTextBox.Text += "  2 " + something + "           " + secondRecordDateFormat.ToLocalTime().ToString() +
                                         "   ";
                sqlResultTextBox.Text += "     " + ((dateStrings[9].ToDecimal()) / 10).ToString(FormatString) + "       ";
                sqlResultTextBox.Text +=
                ...
                sqlResultTextBox.Text += "  3 " + something + "           " + thirdRecordDateFormat.ToLocalTime().ToString() +
                                         "   ";
                sqlResultTextBox.Text += "     " + ((dateStrings[14].ToDecimal()) / 10).ToString(FormatString) + "       ";
                sqlResultTextBox.Text +=
                ...
                sqlResultTextBox.Text += "  4 " + something + "           " + forthRecordDateFormat.ToLocalTime().ToString() +
                                         "   ";
                sqlResultTextBox.Text += "     " + ((dateStrings[19].ToDecimal()) / 10).ToString(FormatString) + "       ";
